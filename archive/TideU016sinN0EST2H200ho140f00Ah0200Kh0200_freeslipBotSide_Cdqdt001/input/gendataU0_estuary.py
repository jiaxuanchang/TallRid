...
runname = 'TideU0%02dsinN0EST2H%03dho%03df00Ah%04dKh%04d_freeslipBotSide_Cdqdt%03d/' % (100*u0,H,h0,10000*Ah,10000*Kh,1000*Cd)
comments = ''
...
rhoE[:20]=rhoNil*(1+b1*z[:20])
rhoE[20:]=rhoNil*(b2*(z[20:]-z[19]))+rhoE[19]
