...
ta_hDispbc = ta_hDispbc1+grid.interp(ta_hDispbc2,['X','Y'],boundary='extrapolate') \
                        +grid.interp(ta_hDispbc31,'X',boundary='extrapolate') \
...
vpCbot=(Vbot-V0C)
absuH=(Ubot**2+Vbot**2)**0.5
D0=rhoNil*Cd*absuH*(Ubot*U0C+Vbot*V0C)
Dp=rhoNil*Cd*absuH*(Ubot*upCbot+Vbot*vpCbot+wbot*wbot)
print('Dp:')
print(Dp)
print('D0:')
print(D0)
